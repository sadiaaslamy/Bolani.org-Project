  ...
  <div class="container  py-28 w-4/5 mx-auto flex flex-col md:flex-row">
    ...
    <div class=" bg-yellow-50 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
      <div class="relative mb-4">
        ...
        <input type="text" id="number" name="number" onkeyup="numBolani(this.value);" placeholder="#Enter the number of Bolani here" class="w-full bg-yellow-50 rounded border border-black-300 focus:border-yellow-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
      </div>
      ...
      <div class="relative mb-4">
        ...
        <input type="amount" id="amount" name="amount" onkeyup="amountCD(this.value);" placeholder="$0" class="w-full bg-yellow-50 rounded border border-black-300 focus:border-yellow-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
      </div>
